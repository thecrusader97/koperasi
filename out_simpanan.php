...
{	
    ...
    $result = mysqli_query($conn, "INSERT INTO t_simpanan(idsimpanan,kode,nominal,adm,sub,kategori,tgl) VALUES('$id','$kode','$nominal','$admraw','$adm','Saldo Di Tarik','$currentDateTime')");
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                                ...
                                <form action="out_simpanan.php" method="post" name="form1">
                                ...
                                <div class="form-group">
                                    <label class="form-label"> nominal Yang mau di tarik:</label>
                                    <input class="form-control" type="text" id="nominal" name="nominal">
                                </div>
                                <div class="form-group">
                                    <label class="form-label"> saldo anda : Rp. <?php echo number_format($total, 0, ',', '.');?> tidak akan bisa menarik saldo jika melebihi saldo</label>
                                ...
                                <div class="form-group">
                                <input class="btn btn-success" type="submit" name="update" value="Tarik">
